...
namespace Plugin.Runtime.Units
{
    ...
    /// </summary>
    public class UnitPoison : BaseActionUnit, IHealthComponent, IHealthBuffComponent, IVipComponent, IHealingAdditional
    {
        ...
        public UnitPoison(UnitFactoryParameters parameters) : base(parameters)
        {
            // Set health
